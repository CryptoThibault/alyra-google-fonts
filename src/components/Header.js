  ...
  return (
    <header className="p-5 bg-danger text-white">
      <div className="form-check form-switch align-top">
        <input className="form-check-input" type="checkbox" id="switchMode" onChange={handleChangeDarkMode} checked={darkMode}></input>
        <label className="form-check-label" htmlFor="switchMode">
